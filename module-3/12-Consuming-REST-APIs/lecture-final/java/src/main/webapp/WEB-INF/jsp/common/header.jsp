    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
	    <ul class="nav navbar-nav">
	      ...
	      <li class="nav-item ${param.activeNav == 'search'? 'active':''}">
	        <c:url value="/search" var="searchUrl"/>
	        <a class="nav-link" href="${searchUrl}">Search</a>
	      </li>
	      <li class="nav-item ${param.activeNav == 'collection'? 'active':''}">
	        <c:url value="/collection" var="collectionUrl"/>
