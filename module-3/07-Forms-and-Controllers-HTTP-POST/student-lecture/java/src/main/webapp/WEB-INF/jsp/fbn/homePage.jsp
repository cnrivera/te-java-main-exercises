...
<section class="account">
  <img src="<c:url value="/img/fbn/piggybank.png"/>" alt="Start Savings">
...
<section class="account">
  <img src="<c:url value="/img/fbn/checkandpen.png"/>" alt="Open Checking">
...
<section class="account">
  <img src="<c:url value="/img/fbn/dollarsign.png"/>" alt="Bridge the Gap">
