...
VALUES ('USA', 'Klingon', false, 0.0000001);

-- 2. Add Klingon as a spoken language in Great Britain

SELECT code FROM country WHERE name = 'United Kingdom';
...
UPDATE city
SET name = substring(name FROM 3 FOR character_length(name) - 4)
WHERE countrycode IN (SELECT code FROM country WHERE gnp >= 1000000);
