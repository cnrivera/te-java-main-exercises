...
public class Example3 {
	...
	public static void main(String[] args) {
		...
		while (gotNumber == false) {
			...
			} catch (NumberFormatException e) { // If a NumberFormatException is thrown by Integer.valueOf(...) it will be
									// caught here since NumberFormatException "is-a" Exception
